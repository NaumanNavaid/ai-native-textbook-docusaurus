...
const config: Config = {
  ...
  url: 'https://naumannavaid.github.io/ai-native-textbook-docusaurus/',
  ...
  organizationName: 'NaumanNavaid', // Usually your GitHub org/user name.
  projectName: 'ai-native-textbook-docusaurus', // Usually your repo name.
